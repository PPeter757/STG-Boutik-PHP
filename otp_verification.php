...
// Vérifier que l'OTP et l'utilisateur temporaire existent
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($entered == $_SESSION['otp_code']) {
        ...
        // Restaurer les sessions définitives
    ...
    <div class="bg-white p-8 rounded-lg shadow-lg w-full max-w-md">
        ...
        <form method="POST">
            <div class="mb-4">
                ...
                <input type="text" name="otp" class="w-full border px-3 py-2 rounded" required>
            </div>
            <button type="submit" class="w-full bg-green-600 text-white py-2 rounded hover:bg-green-700 transition">Vérifier</button>
        </form>

        <p class="mt-4 text-sm text-gray-500 text-center">
            Si vous n'avez pas reçu le code, <a href="resend_otp.php" class="text-blue-600 underline">renvoyer OTP</a>.
        </p>
    </div>
</body>
</html>
